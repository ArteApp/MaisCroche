...
self.toolbox.options.cache = {
  name: 'mais-croche-cache-201803151837'
};
...
const db = new PouchDB('mais-croche');
const remotedb = new PouchDB('https://admin:8eda208157d4@couchdb-bfef4c.smileupps.com/mais-croche');
